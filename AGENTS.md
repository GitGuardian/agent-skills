...
.github/workflows/     # CI: JSON + frontmatter validation, install-flow sanity, release automation, scheduled/on-demand skill evals
scripts/               # headless eval driver (run-evals.mjs + evals.config.json) — see docs/maintainers/evals.md
...
skills/<name>/         # one folder per skill (folder name = SKILL.md frontmatter `name:`)
  ...
  evals/               #   evals.json + targets.json + files/ fixtures (every skill; schema-checked in CI)
