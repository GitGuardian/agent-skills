...
> once the detection context is known. Carries the lifecycle tracks (§ 5–§ 8); for incident
> triage § 5 (pre-leak) is a not-applicable stub, since incidents are post-leak by definition.
> The universal contract — principles, triage axes, deliverable modes, coordination, takedown,
